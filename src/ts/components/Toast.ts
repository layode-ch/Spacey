...
export class Toast extends HTMLDivElement {
    ...
    get type(): ComponentType{
        return this.getAttribute("type") as ComponentType;
    }
    set type(value) {
	 ...
	 */
	static create(message: string, type: ComponentType, delay: number): Toast {
		const toast = document.createElement("div", {is: this.name}) as Toast;
